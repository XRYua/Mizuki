...
export const siteConfig: SiteConfig = {
	...
	siteURL: "https://xryua.dpdns.org/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2002-03-18", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	themeColor: {
		hue: 268, // 主题色的默认色相，范围从 0 到 360。例如：红色：0，青色：200，蓝绿色：250，粉色：345
	...
	bangumi: {
		userId: "fogyua", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
	...
	banner: {
		...
		imageApi: {
			...
			url: "http://domain.com/api_v2.php?format=text&count=8&category=anime&keyword=孤独摇滚", // 示例：使用番剧关键词返回「每行一个图片链接」的文本
